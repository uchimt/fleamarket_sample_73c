...
kids_grandchild_array = [
                          ...
                          ['トップス','アウター','パンツ','おくるみ','下着/肌着','パジャマ','ロンパース','その他'],
                          ['コート','ジャケット/上着','トップス（Tシャツ/カットソー）','トップス（トレーナー）','トップス（チェニック）','トップス（タンクトップ）','トップス（その他）','スカート','パンツ','ワンピース','セットアップ','パジャマ','フォーマル/ドレス','和服','浴衣','甚平','水着','その他'],
...
# インテリア・住まい・小物
interiors_child_array = ['キッチン/食器','ベッド/マットレス','ソファ/ソファベッド','椅子/チェア','机/テーブル','収納家具','ラグ/カーペット/マット','カーテン/ブラインド','ライト/証明','寝具','インテリア小物','季節/年中行事','その他']
interiors_grandchild_array = [
                          ...
                          ['布団/毛布','枕','シーツ/カバー','その他'],
                          ['ごみ箱','ウェルカムボード','オルゴール','クッション','クッションカバー','スリッパラック','ティッシュボックス','バスケット/かご','フォトフレーム','マガジンラック','モビール','花瓶','灰皿','傘立て','小物入れ','置時計掛時計/柱時計','鏡(立て掛け式)','鏡(壁掛け式)','置物','風鈴','植物/観葉植物','その他'],
