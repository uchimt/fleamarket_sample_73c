...
parent = ProductsSize.create(size: '服のサイズ')
...
parent = ProductsSize.create(size: 'レディース靴のサイズ')
...
parent = ProductsSize.create(size: 'メンズ靴のサイズ')
...
parent = ProductsSize.create(size: 'キッズ服のサイズ　〜95cm')
...
parent = ProductsSize.create(size: 'キッズ服のサイズ　100cm〜')
...
parent = ProductsSize.create(size: 'キッズ靴のサイズ')
...
parent = ProductsSize.create(size: 'タイヤのサイズ')
